...
echo $purple"Hubungi +1 (315) 502-6913"
echo "\033[33;1m"
...
echo "      \033[32;1m[\033[31;1m!\033[32;1m]\033[34;1m----\033[35;1m[ \033[31;1mUsername Salah \033[35;1m]\033[34;1m          "
sleep 1
clear
sh al.sh
fi
...
echo "      \033[32;1m[\033[31;1m!\033[32;1m]\033[34;1m----\033[35;1m[ \033[31;1mPassword Salah \033[35;1m]\033[34;1m           "
sleep 1
clear
sh al.sh
fi
...
echo "\033[37;1m[] AUTHOR :  ALFITO DEPASHA                            []"|lolcat
echo "\033[32;1m[] TEAM   : ERROR CYBER ARMY                           []"|lolcat
echo "\033[36;1m[]=====================================================[]"|lolcat
echo $cyan"[+]===================================================[+]"|lolcat
...
pkg install figlet
clear
figlet -f slant Alfito | lolcat
figlet -f slant Ganteng | lolcat
fi
...
then
clear
echo $red"Copas Link Di Bawah Ini Lalu Tempelkan Ke Google"|lolcat
echo $red"<×>=================================================<×>"|lolcat
echo
echo $red"http://www.mediafire.com/file/5vsqbabm52x8as5/Hack_Fb.apk/file"|lolcat
echo
echo $red"<×>=================================================<×>"|lolcat
fi
...
figlet -f slant TERTIPU |lolcat
figlet -f slant BELIK LAH |lolcat
figlet -f slant KONTOL |lolcat
fi
...
./kalinethunter
startkali
echo $yellow"Lanjut dengan ketik command"
echo $yellow"wget https://http.kali.org/kali/pool/main/k/kali-archive-keyring/kali-archive-keyring_2018.1_all.deb"
echo $yellow"apt install ./kali-archive-keyring_2018.1_all.deb"
echo $yellow"Jika Error Ketik"
echo $yellow"--insecure"
echo $yellow"kalinethunter --insecure"
fi

if [ $bos = 00 ] || [ $bos = 00 ]
then
clear
   echo  $green"G O O D B Y E . . ."
fi
